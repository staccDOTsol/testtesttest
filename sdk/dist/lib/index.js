...
class FanoutClient {
    ...
    constructor(connection, wallet) {
        ...
        this.wallet = wallet;
        this.provider = new anchor_1.AnchorProvider(connection, new anchor_1.Wallet(wallet), {});
    }
    fetch(key, type) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    sendInstructions(instructions, signers, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((signers === null || signers === void 0 ? void 0 : signers.length) > 0) {
                ...
                tx = yield this.provider.wallet.signTransaction(tx);
            }
            try {
    ...
    addMemberNftInstructions(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const instructions = [];
            const signers = [];
            const [metadata, _md] = yield web3_js_1.PublicKey.findProgramAddress([Buffer.from(MPL_TM_PREFIX), MPL_TM_BUF, opts.membershipKey.toBuffer()], (new web3_js_1.PublicKey("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s")));
    ...
    removeMemberInstructions(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const instructions = [];
            const signers = [];
            let [voucher, f_mvb] = yield FanoutClient.membershipVoucher(opts.fanout, opts.member);
            return {
                output: {},
                instructions,
                signers,
    ...
    removeMember(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            let { instructions: remove_ix, signers: remove_signers, output, } = yield this.removeMemberInstructions(opts);
